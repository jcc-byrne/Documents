...
var sql = "SELECT h.* \n" +
"FROM b1permit p join bappspectable_value h on h.b1_per_id1 = p.b1_per_id1 and h.b1_per_id2 = p.b1_per_id2 and h.b1_per_id3 = p.b1_per_id3 \n" +
"WHERE p.SERV_PROV_CODE = ? \n" +
"AND  p.b1_alt_id like 'E-000171' \n" 
