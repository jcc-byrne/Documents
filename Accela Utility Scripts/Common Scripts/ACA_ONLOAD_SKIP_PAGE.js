/*------------------------------------------------------------------------------------------------------/
| Program : ACA_ONLOAD_SKIP_SOCIAL_EQUITY.js
| Event   : ACA Page Flow onload
|
| Usage   : Master Script by Accela.  See accompanying documentation and release notes.
|
| Client  : FRESNO
| Action# : Jacob Clay (Byrne Software)
|
| Notes   :
|
/------------------------------------------------------------------------------------------------------*/
...
*/
	...
	var thisPageValue = "Yes";  // change per page
	var showPage = (thisPageValue.equals(AInfo["SErelated"]));
