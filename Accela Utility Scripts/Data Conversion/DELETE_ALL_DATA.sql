...
DELETE FROM MRULIST
WHERE SERV_PROV_CODE= @SPC AND ENTITY_TYPE LIKE '%CAP%' 
...
WHERE 
G7CONTACT_ADDRESS.serv_prov_code = @SPC
...
DELETE FROM G7SERIES_UPDATE_LOG WHERE SERV_PROV_CODE=@SPC AND 
...
DELETE FROM GAUDIT_HISTORY WHERE SERV_PROV_CODE=@SPC AND ENTITY_TYPE IN ('0','1','2','3','4','9','10','11','12','13','15','16','17','18','19','20','21','22','23')
                  and ENTITY_ID IN (SELECT B1_pER_ID1+'-'+B1_PER_ID2+'-'+B1_PER_ID3 FROM #REMOVE_PER_LIST);
PRINT FORMAT(@@ROWCOUNT,'N0') + ' row(s) deleted'

PRINT 'DELETE FROM GCONT_EDU'
DELETE FROM GCONT_EDU WHERE SERV_PROV_CODE=@SPC AND ENT_TYPE='CAP_CONTEDU' 
...
PRINT 'DELETE FROM GEDUCATION'
DELETE FROM GEDUCATION WHERE SERV_PROV_CODE=@SPC AND ENT_TYPE='CAP_EDU' 
...
PRINT 'DELETE FROM GEXAM'
DELETE FROM GEXAM WHERE SERV_PROV_CODE=@SPC AND ENT_TYPE='CAP_EXAM' 
