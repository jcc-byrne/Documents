...
function sbcoSelectSingleRecord(pId1, pId2, pId3)
{
    ...
    */        
    ...
    cSql = " BEGIN " +
            ...
            " set @MERCHANT_CONF  ='PARTNER=PayPal;VENDOR=Brea123;USER_NAME=APIAccelaAutomation;PASSWORD=dhb%*FJSnn@#23mn;CHECKPARTNER=PayPal;CHECKVENDOR=Brea123;CHECKUSER_NAME=Brea123;CHECKPASSWORD=May232001###' " +
