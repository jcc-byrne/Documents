...
| Notes   : MKEBL-235, require Proof of Nonprofit Status if ASI criteria matches 
...
function checkLoadingZoneNPO() {
    var requieNPOdoc= false;
    if (appMatch("Licenses/Business/Loading Zone/Application") || appMatch("Licenses/Business/Loading Zone/Renewal")) {
  
      if (AInfo['Non Profit Loading Zone'] == 'Yes' || AInfo['Non Profit Loading Zone'] == 'YES' ){
          requieNPOdoc = true;
      }
      ...
      if (requieNPOdoc) {
        ...
        for (docs in docModelArray) {
          ...
          if (uploadedDocs[docs] == "Proof of Nonprofit Status") {
            permitAttachment = true;
          }
        }
        ...
        if (permitAttachment) {
          ...
          cancel = true;
          showMessage = true;
          message = "<br><font color=red>Required Documents Missing: 'Proof of Nonprofit Status'" + "<br>" + "</font><br>";
          // comment(message);
        }
      }
      }
