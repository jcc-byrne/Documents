...
if (appMatch('Licenses/Transportation/Recycle Salvage Vehicle/Application') || appMatch('Licenses/Transportation/Recycle Salvage Vehicle/Renewal')  ){

    if (wfTask == 'Application Submittal' && wfStatus == 'Complete'){
        logDebug('>>>Start of 238')
