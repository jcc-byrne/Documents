...
if (appMatch('Licenses/Business/Massage Establishment/Application') && !feeExists('LICMAS03')){
    if (!matches(AInfo['Months to Prorate Fee'], null, undefined, '')){
        logDebug('Prorate Months: ' + AInfo['Months to Prorate Fee']);
        licFeeAmt = feeAmount('LICMAS01');
        ...
        if (licFeeAmt){
            ...
            feeQty = licFeeAmt / AInfo['Months to Prorate Fee'];
            addFeeWithExtraData('LICMAS03', 'LIC_MAS_APP', 'FINAL', feeQty, 'Y', capId, feeMsg, null, null)
        }
