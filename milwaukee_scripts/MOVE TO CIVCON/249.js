...
exploreObject(cap.getCapModel().getCapParcelList())
exploreObject(cap.getCapModel().getParcelList())
exploreObject(cap.getCapModel().getParcelModel())
exploreObject(cap.getCapModel().getCapParcelModel())
