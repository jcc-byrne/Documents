var myCapId = 'CLSP22-00012';
var myUserId = 'ADMIN';

/* ASA  */ //var eventName = "ApplicationSubmitAfter";
/* WTUA */ var eventName = "WorkflowTaskUpdateAfter"; wfTask = "Inspections"; wfStatus = "Fees Due"; wfHours = 10; wfDate = "01/27/2015"; wfComment = "Test Comment"; wfStaffUserID = 'Admin'
...
//task 259 - JCC
  if (wfStatus == 'Fees Due'){
    emailInvoice(["Applicant", "Billing Contact", "Authorized Agent"])
    addConditionsWithTypeAndGroup("Site Development Plan","Fees Due","This record is currently on hold until all fees are paid.","Notice","Applied","Y","N","Y")  
}
...
function exploreObject(objExplore) {
  ...
  function addConditionsWithTypeAndGroup(conGroup, conType, conDesc, conStatusType, conStatus, isACA, isACAFee, isAA) {
    ...
    var condAdded = aa.capCondition.addCapCondition(capId, conType, conDesc, "", sysDate, null, sysDate, null, null, conStatusType, systemUserObj, systemUserObj, conStatus, currentUserID, "A", conStatus, isAA, "Y", "Y", "N", conDesc, "N", "", "", "", "", conGroup, isACA, isACAFee);

    if (condAdded.getSuccess()){
        logDebug(condAdded.getOutput())
    } else {
        logDebug(condAdded.getErrorMessage())
    }
}