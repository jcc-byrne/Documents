var myCapId = '2024-00144';
var myUserId = 'ADMIN';

/* ASA  */ //var eventName = "ApplicationSubmitAfter";
/* WTUA */ var eventName = "WorkflowTaskUpdateAfter"; wfTask = "Extension Review"; wfStatus = "Permit Extended"; wfHours = 10; wfDate = "01/27/2015"; wfComment = "Test Comment"; wfStaffUserID = 'Admin'; wfProcess = 'BLD'
...
debug = ''
  ...
  var months = AInfo['Extension Time']

if (wfTask == 'Extension Review' && wfStatus == 'Permit Extended' && appMatch('Building/Amendment/Extension/NA')) {
  months = Number(months.split(' ')[0])
  // logDebug('Months : ' + months);
  // logDebug('Date: ' + dateAddMonths(null, months)); 
  if (parentCapId){
    editAppSpecific('Application Expiration Date', dateAddMonths(null, months), parentCapId)
  };
}
